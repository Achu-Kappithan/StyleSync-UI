...
const PAGE_TITLES: Record<string, { title: string; sub: string }> = {
  ...
  services:     { title: 'Services',     sub: 'Services Master & Pricing' },
  categories:   { title: 'Categories',   sub: 'Service Categories & Sub-Categories' },
  packages:     { title: 'Packages',     sub: 'Bundled Multi-Session Offers' },
  memberships:  { title: 'Memberships',  sub: 'Subscription Plans & Tiers' },
